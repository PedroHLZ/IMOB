...
<div class="container py-4">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="approval_status" name="approval_status">
                        ...
                        <option value="Conformidade" <?= $client['approval_status'] == 'Conformidade' ? 'selected' : '' ?>>Conformidade</option>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-primary text-white py-3">
            <h5 class="card-title mb-0"><i class="fas fa-paperclip me-2"></i> Anexos</h5>
        </div>
        <div class="card-body">
            <label for="attachments" class="form-label">Adicionar novos anexos (fotos, PDFs)</label>
            <input type="file" class="form-control mb-3" id="attachments" name="attachments[]" multiple accept="image/*,application/pdf">
