<?php
// Página: Listagem de Leads
ob_start();
?>
<h1 class="mb-4"><i class="fas fa-list me-2"></i>Leads Cadastrados</h1>

<?php if (empty($leads)): ?>
    <div class="alert alert-info">Nenhum lead cadastrado.</div>
<?php else: ?>
                ...
                <?php foreach ($leads as $lead): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            <span class="badge bg-<?= $statusClass ?> px-2 py-2 fs-6 shadow-sm"><?= htmlspecialchars($lead['status']) ?></span>
                        </td>
                        <td>
